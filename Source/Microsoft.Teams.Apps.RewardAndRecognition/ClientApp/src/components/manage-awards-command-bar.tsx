...
import { Button, Input, Dialog, Flex } from "@fluentui/react-northstar";
    ...
    public render(): JSX.Element {
        ...
        return (
            <Flex gap="gap.small" className="commandbar-wrapper">
                <Button icon="add" content={t('addButtonText')} text disabled={!this.props.isAddEnabled} className="add-new-button" onClick={() => this.props.onAddButtonClick()} />
